...
public class LiveConcertsInfoListProvider
  ...
  protected String getLabelKey() {
    ...
    return "workshop.concert.collection.providers.live-concerts";
  }
  ...
  private static final Logger log = LoggerFactory.getLogger(LiveConcertsInfoListProvider.class);
