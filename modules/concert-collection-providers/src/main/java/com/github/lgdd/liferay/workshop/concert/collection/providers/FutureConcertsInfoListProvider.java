...
public class FutureConcertsInfoListProvider
  ...
  protected String getLabelKey() {
    ...
    return "workshop.concert.collection.providers.future-concerts";
  }
  ...
  private static final Logger log = LoggerFactory.getLogger(FutureConcertsInfoListProvider.class);
